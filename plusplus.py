...
class Kmean_plus():
    ...
    def snap(self, centers):
        TEMPFILE = f"plusplus{self.timestamp}.png"
        # fig, ax = plt.subplots()
    ...
    def initialize(self):
        ...
        for _ in range(1, self.k):
            ...
            next_center_idx = np.random.choice(np.arange(n_samples), p=probabilities)
...
# kmean=Kmean_plus(data,2)
# kmean.lloyds()
# kmean.create_gif('plus.gif')
